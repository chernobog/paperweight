...
const structuredData = [
  ...
  },
  {
    "@context": "https://schema.org",
    "@type": "HowTo",
    name: "How email cleanup works",
    description:
      "Paperweight separates actionable mailing lists from the rest of your mail, then lets you review and unsubscribe in one place.",
